...
CREATE TABLE `lookup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=130559 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `source` (
  ...
  `publication` varchar(256) NOT NULL DEFAULT '',
  `score` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `creator_id` (`creator_id`),
  CONSTRAINT `source_ibfk_1` FOREIGN KEY (`creator_id`) REFERENCES `useraccount` (`id`)
...
-- Dump completed on 2012-01-27  8:11:43
